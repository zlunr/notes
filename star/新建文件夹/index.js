...
<div id="switcher">
    <div class="center">
        <ul>
            ...
            <li class="logoTop">
                <a href="http://www.17sucai.com/pins/29409.html">纯css3五星评分打分代码</a>            <script type="text/javascript">
                jQuery('#output').qrcode({width:150,height: 150,text: window.location.href});
            </script>
            <li class="remove_frame"><a href="http://www.17sucai.com/preview/1232113/2018-06-05/xx/demo.html" title="移除框架"></a></li>
        </ul>
    </div>
</div>

<div id="iframe-wrap">
    <iframe id="iframe" src="http://www.17sucai.com/preview/1232113/2018-06-05/xx/demo.html" frameborder="0"  width="100%"></iframe>
</div>
